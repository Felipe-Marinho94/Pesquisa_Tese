...
#---------------------------------------------------------------
def fit_SCG_LSSVM(X, y, gamma, kernel, epsilon, tolerancia, N):
    '''
    Interface do método
...
X = np.random.normal(10, 1 , size=(2000, 5))
y = np.random.normal(10, 1, 2000)
resultados = fit_SCG_LSSVM(X, y, 0.5, 'gaussiano', 1.5, 0.01, 100)
...
#---------------------------------------------------------------
#Função para ajustar o modelo LSSVM utilizando um novo método dos
#gradientes conjugados espectrais em conjunto com o SMO
#SOURCE: https://journalofinequalitiesandapplications.springeropen.com/articles/10.1186/s13660-020-02375-z
#---------------------------------------------------------------
